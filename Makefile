...
INSTALL			= /home/paras/ns-allinone-2.35/tcl8.5.10/unix/../unix/install-sh -c
...
RANLIB			= ranlib
DTRACE			= 
SRC_DIR			= /home/paras/ns-allinone-2.35/tcl8.5.10/unix
TOP_DIR			= $(SRC_DIR)/..
BUILD_DIR		= .
...
DLTEST_DIR		= /home/paras/ns-allinone-2.35/tcl8.5.10/unix/dltest
# Must be absolute to so the corresponding tcltest's tcl_library is absolute.
TCL_BUILDTIME_LIBRARY	= /home/paras/ns-allinone-2.35/tcl8.5.10/library
...
${TCL_EXE}: ${TCLSH_OBJS} ${TCL_LIB_FILE}
	${CC} ${CFLAGS} ${LDFLAGS} ${TCLSH_OBJS} -L/home/paras/gsoc/new/myffmpeg/FFmpeg -ltcl8.5 ${LIBS}  \
...
tcltest-real:
	${CC} ${CFLAGS} ${LDFLAGS} ${TCLTEST_OBJS} -L/home/paras/gsoc/new/myffmpeg/FFmpeg -ltcl8.5 ${LIBS}  \
...
xttest:  ${XTTEST_OBJS} ${GENERIC_OBJS} ${UNIX_OBJS} ${COMPAT_OBJS} \
	...
	${CC} ${XTTEST_OBJS} ${GENERIC_OBJS} ${UNIX_OBJS} ${COMPAT_OBJS} \
		tclLoadDl.o -L/home/paras/gsoc/new/myffmpeg/FFmpeg -ltcl8.5 ${LIBS} \
